...
require.register("src/addons/action_bar_addon.es6", function(exports, require, module) {
"use strict";
...
function ActionBar($) {
    ...
    var testSpellIcon1 = $.newStatusIcon("UIParent", 2).setPos(game.world.centerX - 50 / 2 - 300, game.world.centerY - 50 / 2 + 350);
    var testSpellIcon2 = $.newStatusIcon("UIParent", 5).setPos(game.world.centerX - 50 / 2 - 350, game.world.centerY - 50 / 2 + 350);
}
});

;require.register("src/addons/castbar.es6", function(exports, require, module) {
"use strict";
...
function CastFrame($) {
    ...
    // Frame
    var castingFrame = new $.newFrame("UIParent").setPos(game.world.centerX - config.width / 2, game.world.centerY - config.height / 2 + 250).setAlpha(0);
...
;require.register("src/addons/console.es6", function(exports, require, module) {
...
;require.register("src/addons/debug.es6", function(exports, require, module) {
"use strict";
...
function Debug($) {
    ...
    function onRenderGame() {
        ...
        if (player.target) {
            ...
            game.debug.text("#### Health: " + player.target.getHealth(), 20, 100, '#00FF96');
            game.debug.text("#### Class: " + player.target.classId, 20, 120, '#00FF96');
            game.debug.text("#### Absorb: " + player.target.getCurrentAbsorb(), 20, 180, '#00FF96');
        }
...
;require.register("src/addons/raid_frame.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/addons/spell_effects.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/addons/timers.es6", function(exports, require, module) {
"use strict";
...
function BigWigs($) {
    ...
    var timerFrame = $.newFrame("UIParent").setPos(game.world.centerX + 250, game.world.centerY + 100);

    var emphasizedTimerFrame = $.newFrame("UIParent");

    /*    Create test timer, when timers are finished they will either be removed or respawn  */
    {
        // -- SCOPE / ANONYMOUS NAMESPACE?--

        var timer = new $.newStatusBar(timerFrame, 200, 25).setValues(0, 1, 1, true).setValue(0, 30000).setColor(0xFF5E14);
...
;require.register("src/addons/unit_frames.es6", function(exports, require, module) {
"use strict";
...
function UnitFrames($) {
   ...
   * Players unit frame
   */
  var playerFrame = $.newUnitFrame("UIParent", $.localPlayer(), 300, 50).togglePowerBar().setPos(game.world.centerX - 300 / 2 - 300, game.world.centerY - 50 / 2 + 250);
   ...
   * Target's unit frame
   */
  var targetFrame = $.newUnitFrame("UIParent", $.localPlayer().target, 300, 50).setPos(game.world.centerX - 300 / 2 + 300, game.world.centerY - 50 / 2 + 250);;
  ...
  var bossFrame = $.newUnitFrame("UIParent", testBoss, 300, 50).setPos(game.world.centerX + 250, game.world.centerY + 10);
}
});

;require.register("src/enums.es6", function(exports, require, module) {
"use strict";
...
require.register("src/gameObjects/addonManager.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/gameObjects/addon_api/api.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/gameObjects/addon_api/frame.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/gameObjects/addon_api/status_bar.es6", function(exports, require, module) {
"use strict";
...
var StatusBar = function (_Frame) {
  ...
  _createClass(StatusBar, [{
    ...
    value: function setValue(newValue, duration) {
      ...
      if (duration) this._animationDuration = duration;else if (duration === 0) this._animationDuration = 0;
...
;require.register("src/gameObjects/addon_api/status_icon.es6", function(exports, require, module) {
"use strict";
...
var StatusIcon = function (_Frame) {
  ...
  function StatusIcon(parent, spellid, events) {
    ...
    _this._events.ON_COOLDOWN_START.add(function (e) {
      return _this._onCooldownStart(e);
    });
    _this._events.ON_COOLDOWN_ENDED.add(function (e) {
  ...
  _createClass(StatusIcon, [{
    ...
    value: function _onCooldownStart(event) {
      ...
      this._events.GAME_LOOP_UPDATE.add(function () {
...
;require.register("src/gameObjects/addon_api/unit_frame.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/gameObjects/boss.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/gameObjects/class_modules/priest.es6", function(exports, require, module) {
"use strict";
...
var flash_of_light = function (_SpellBase) {
    ...
    _createClass(flash_of_light, [{
        key: "getCastTime",
        value: function getCastTime() {
            var ct = _get(Object.getPrototypeOf(flash_of_light.prototype), "getCastTime", this).call(this);
...
var power_word_shield = function (_SpellBase2) {
    ...
    _createClass(power_word_shield, [{
        ...
        value: function isUsable() {
            ...
            if (this.target.hasAura("weakened_soul")) return false;
        }
    }, {
        key: "onExecute",
        value: function onExecute() {
...
;require.register("src/gameObjects/data.es6", function(exports, require, module) {
...
require.register("src/gameObjects/eventManager.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/gameObjects/player.es6", function(exports, require, module) {
"use strict";
...
var Player = function (_Unit) {
  ...
  function Player(_class, race, level, name, events, isEnemy) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Player).call(this, _class, race, level, name, events, isEnemy));

    _this.specialization = null; // spec
    return _this;
  }
...
;require.register("src/gameObjects/raid.es6", function(exports, require, module) {
"use strict";
...
var Raid = function () {
  ...
  _createClass(Raid, [{
    ...
    value: function generateTestPlayers() {
      var numberOfTanks = void 0,
          numberOfHealers = void 0,
          numberOfDps = void 0;
      ...
      while (numberOfHealers--) {
        var _classs = validHealerClasses[_util.rng.integerInRange(0, validHealerClasses.length - 1)],
            _race = _util.rng.integerInRange(e.player_race.MIN, e.player_race.MAX),
            _level = 100,
            _name = data.generatePlayerName();

        var _unit = this.createUnit(_classs, _race, _level, _name);
        this.addPlayer(_unit);
      }

      while (numberOfDps--) {
        var _classs2 = _util.rng.integerInRange(e.player_class.MIN, e.player_class.MAX),
            _race2 = _util.rng.integerInRange(e.player_race.MIN, e.player_race.MAX),
            _level2 = 100,
            _name2 = data.generatePlayerName();

        var _unit2 = this.createUnit(_classs2, _race2, _level2, _name2);
        this.addPlayer(_unit2);
      }
    }
    ...
    value: function bossSwing() {
      ...
      var bossSwing = _util.rng.between(90000, 115900);
    ...
    value: function raidDamage() {
      ...
      for (; i < this.players.length; i++) {
        var unit = this.players[i];
        unit.apply("APPLY_DIRECT_DAMAGE", { amount: _util.rng.between(85555, 168900), type: "fire" });
      }
    }
  }, {
    key: "singleTargetDamage",
    value: function singleTargetDamage() {
      var random = _util.rng.between(2, this.players.length - 1);
      this.players[random].apply("APPLY_DIRECT_DAMAGE", { amount: _util.rng.between(100000, 150000), type: "fire" });
    }
  }, {
    ...
    value: function startTestDamage() {
      ...
      var bossSingelTargetSpell = setInterval(this.singleTargetDamage.bind(this), 60000);
      ...
      var manaRegenYolo = setInterval(this.gainMana.bind(this), 1200);
...
;require.register("src/gameObjects/spell_base.es6", function(exports, require, module) {
"use strict";
...
var SpellBase = function () {
    ...
    function SpellBase(spelldata, player) {
        ...
        var current_cast = void 0,
            current_cooldown = void 0;
    }
    ...
    _createClass(SpellBase, [{
        ...
        value: function _execute() {
            ...
            if (this.hasCooldown) this._startCooldown();
        }
    }, {
        key: "_startCasting",
        value: function _startCasting() {
            var _this = this;

            this.player.isCasting = true;
            // ### TODO: Need to be able to handle channeled spells ###
            var ct = this.getCastTime();
            this.current_cast = game.time.events.add(ct, function () {
                return _this._onCastFinished();
            });
        ...
        value: function _startCooldown() {
            ...
            this.current_cooldown = game.time.events.add(cd, function () {
                return _this2._onCooldownReady();
            });
        ...
        key: "_onCastFinished",
        value: function _onCastFinished() {
            this.player.isCasting = false;
            this.player.events.UNIT_FINISH_SPELLCAST.dispatch();
            this._execute();
        }
    }, {
        key: "_consumeResource",
        value: function _consumeResource() {
            if (!this.hasPowerCost) return;
            this.player.consume_resource(this.powerCost);
        }
    }, {
        key: "_onCooldownReady",
        value: function _onCooldownReady() {
            this.onCooldown = false;
        ...
        value: function use() {
            ...
            if (this.isInstant) this._execute();else this._startCasting();
        }
    }, {
        key: "cooldown",
...
;require.register("src/gameObjects/unit.es6", function(exports, require, module) {
"use strict";
...
var Unit = function () {
    function Unit(_class, race, level, name, _events, isEnemy) {
    ...
    _createClass(Unit, [{
        ...
        key: "apply",
        value: function apply(actionType, actionData) {
            var _this = this;
            ...
            switch (actionType) {
                ...
                case "APPLY_AURA_ABSORB":
                    ...
                    // Add aura to array
                    var auraid = this._auras.push(actionData);

                    // Schedule removal of aura if it should expire at some point.
                    if (actionData.duration > 0) {
                        game.time.events.add(actionData.duration, function () {
                            _this._auras[auraid] = undefined;console.log("aura done");
                        });
                    }
                    break;
            }
        ...
        key: "setMana",
        value: function setMana(value) {
            if (this.getMana() + value > this.getMaxMana()) this._stats.mana.value = this.getMaxMana();else if (value < 0) this._stats.mana.value = 0;else this._stats.mana.value += value;
        ...
        key: "assessDamageTaken",
        value: function assessDamageTaken(damage) {
        ...
        key: "_consumeAbsorb",
        value: function _consumeAbsorb(dmg) {
        ...
        value: function cast_spell(spellName) {
            ...
            // ## Find spell ####
            if (!this._spells[spellName]) return;
        ...
        key: "getResistanceMultiplier",
        value: function getResistanceMultiplier(resistanceType) {
...
;require.register("src/main.es6", function(exports, require, module) {
'use strict';
...
window.onload = function () {
   ...
   */
  window.game = new PhaserCustomGame(window.innerWidth, window.innerHeight, Phaser.WEBGL, undefined, _boot2.default);
};
});

require.register("src/states/boot.es6", function(exports, require, module) {
"use strict";
...
var Boot = function () {
  ...
  _createClass(Boot, [{
    ...
    value: function create() {
      ...
      this.game.state.add("Success", _success2.default);
...
;require.register("src/states/menu.es6", function(exports, require, module) {
"use strict";
...
var MainMenu = function () {
    ...
    _createClass(MainMenu, [{
        ...
        value: function create() {
            ...
            var bg = this.add.image(0, 0, "menu_bg");
            ...
            var nameInputField = game.add.inputField(150, 910, {
                font: '17px Arial',
                fill: '#FFFFFF',
                fontWeight: 'bold',
                width: 250,
            ...
            {
                (function () {
                    var onPlayButtonPressed = function onPlayButtonPressed() {
                    ...
                    var playbutton = _this.add.sprite(window.innerWidth - 500, window.innerHeight - 300, "play_button");
                    ...
                    playbutton.events.onInputDown.add(onPlayButtonPressed, _this);
                })();
            }
            ...
            function createOptionPanel(configObject) {
                ...
                if (configObject.headerText) {
                    ...
                    var headerText = game.add.bitmapText(anchors.headerText.x, anchors.headerText.y, "myriad", configObject.headerText, 15);
                ...
                for (var button in configObject.buttons) {
                    var currentButton = configObject.buttons[button];
                    var displayObject = game.add.sprite(100, anchors.button, currentButton.icon);
...
;require.register("src/states/play.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/states/success.es6", function(exports, require, module) {
"use strict";
...
;require.register("src/util.es6", function(exports, require, module) {
'use strict';
